...
void quadratic(double a, double b, double c,
    ...
    if (a == 0){
        if (b == 0){
            first_real = second_real = first_imag = second_imag = 0;
        } else {
            first_real = second_real = -c / b;  
        }
    } else {
        if (discrim >= 0){
            first_real = (-b + sqrt(discrim)) / (2.0 * a);
            second_real = (-b - sqrt(discrim)) / (2.0 * a);
            first_imag = second_imag = 0;
        } else {
            first_real = second_real = -b / (2.0 * a);
...
void display_results(double first_real, double first_imag,
    ...
    if (first_imag == 0 && second_imag == 0){
        ...
        << "j and " << second_real << second_imag << "j." << endl << endl;
    }
}